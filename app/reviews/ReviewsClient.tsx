          ...
          <div className="max-w-[1120px] mx-auto">
            {loading ? (
              ...
              >
                ...
                <p className="text-[14px] text-secondary max-w-[400px] mx-auto mb-6">
                  Be one of the first to share your experience with SpendWise.
                </p>
                <Link
                  href="/download"
                  className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-full bg-primary-600 text-white font-bold text-[14px] hover:bg-primary-700 transition-all"
                >
                  Get Started
                  <ArrowRight size={16} />
                </Link>
          ...
          <section className="pb-16 px-5 md:px-10">
            <div className="max-w-[1120px] mx-auto">
              <motion.div
                ...
                whileInView="visible"
                viewport={{ once: true }}
                className="rounded-2xl border border-border-subtle bg-surface p-8 md:p-10 text-center"
              >
                <h2 className="text-[20px] md:text-[24px] font-bold text-foreground mb-4">
                ...
                <div className="flex flex-wrap items-center justify-center gap-4">
                  <Link
                    href="/download"
                    className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-full bg-primary-600 text-white font-bold text-[14px] shadow-lg shadow-primary-600/25 hover:bg-primary-700 hover:shadow-xl transition-all"
                  >
                    Get Started Free
                    <ArrowRight size={16} />
                  </Link>
                  <Link
                    href="/features"
                    className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-full border border-border-subtle bg-surface text-[14px] font-bold text-foreground hover:border-primary-500/30 transition-all"
                  >
                    Explore Features
                  </Link>
                </div>

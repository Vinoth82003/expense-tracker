      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            className="w-full py-4 px-6 rounded-2xl bg-foreground text-background font-black text-lg flex items-center justify-center gap-3 shadow-xl hover:shadow-2xl transition-all"
          >

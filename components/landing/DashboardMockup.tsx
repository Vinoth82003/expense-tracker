...
export function DashboardMockup({
  ...
  const finalChartHeights = chartHeights || [40, 70, 45, 90, 65, 80, 55];
    ...
    <div className="w-full max-w-4xl mx-auto p-4 sm:p-6 rounded-[2.5rem] bg-background border border-border-subtle shadow-2xl relative overflow-hidden backdrop-blur-sm min-h-[640px] md:min-h-[520px] lg:min-h-[490px]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 relative z-10">
        <div>
          ...
          <h3 className="text-2xl font-black text-foreground">Hey {userName}! 👋</h3>
          <p className="text-sm text-secondary font-bold">Your financial pulse for {monthLabel}.</p>
        </div>

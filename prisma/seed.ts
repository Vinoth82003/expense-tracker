  ...
  const faqs = [
    {
      ...
      answer:
        "Yes, SpendWise is completely free for personal use. We believe everyone deserves access to high-quality financial tracking without paywalls or hidden subscriptions.",
      category: "General",
      order: 1,
    },
    {
      ...
      answer:
        "Simply sign in with your Google account. No complex registration or email verification required—you'll be tracking your first expense in under 30 seconds.",
      category: "General",
      order: 2,
    },
    {
      ...
      answer:
        "Extremely. We use industry-standard encryption and secure OAuth 2.0 via Google. We never see or store your passwords, and your data is stored behind multiple layers of security.",
    ...
    },
    {
      ...
      answer:
        "Our proprietary AI analyzes your spending patterns to find 'leaks' (wasteful spending) and provides data-driven advice to help you reach your goals faster.",
